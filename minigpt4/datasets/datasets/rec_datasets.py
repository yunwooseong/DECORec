...
class MoiveOOData(RecBaseDataset):
    def __init__(self, text_processor=None, ann_paths=None):
        ...
        if 'sessionItems' in self.annotation.columns or 'his' in self.annotation.columns:
            used_columns = ['uid','iid','title','his', 'his_title','label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            renamed_columns = ['UserID','TargetItemID','TargetItemTitle', 'InteractedItemIDs', 'InteractedItemTitles','label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            ...
            used_columns = ['uid','iid','title','label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            renamed_columns = ['UserID','TargetItemID','TargetItemTitle','label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            if 'context_plus_fin' in self.annotation.columns:
                used_columns.append('context_plus')
                renamed_columns.append('context_plus_fin')
            if 'random_context_minus' in self.annotation.columns:
                used_columns.append('random_context_minus')
                renamed_columns.append('random_context_minus')
            if 'adver_context_minus' in self.annotation.columns:
                used_columns.append('adver_context_minus')
                renamed_columns.append('adver_context_minus')
            if 'irr_context_minus' in self.annotation.columns:
                used_columns.append('irr_context_minus')
                renamed_columns.append('irr_context_minus')
            if 'not_cold' in self.annotation.columns:
                used_columns.append('not_cold')
                renamed_columns.append("prompt_flag")
                self.prompt_flag = True
    ...
    def __getitem__(self, index):
        ...
        if self.use_his:
            ...
            one_sample = {
                ...
                "InteractedNum": InteractedNum,
                "label": ann['label'],
                "context_plus_fin": ann.get('context_plus_fin', 'unknown'),
                "random_context_minus": ann.get('random_context_minus', 'unknown'),
                "adver_context_minus": ann.get('adver_context_minus', 'unknown'),
                "irr_context_minus": ann.get('irr_context_minus', 'unknown'),
            }
            if self.prompt_flag:
...
class MoiveOOData_sasrec(RecBaseDataset):
    def __init__(self, text_processor=None, ann_paths=None,sas_seq_len=25):
        ...
        if 'sessionItems' in self.annotation.columns or 'his' in self.annotation.columns or 'context_plus_fin' in self.annotation.columns:
            used_columns = ['uid', 'iid', 'title', 'his', 'his_title', 'label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            renamed_columns = ['UserID', 'TargetItemID', 'TargetItemTitle', 'InteractedItemIDs', 'InteractedItemTitles', 'label', 'context_plus_fin', 'random_context_minus', 'adver_context_minus', 'irr_context_minus']
            if 'not_cold' in self.annotation.columns:
                used_columns.append("not_cold")
            ...
            used_columns = ['uid','iid','title','label','context_plus_fin']
            renamed_columns = ['UserID','TargetItemID','TargetItemTitle','label','context_plus_fin']
            if 'context_plus_fin' in self.annotation.columns:
                used_columns.append('context_plus_fin')
                renamed_columns.append('context_plus_fin')
            if 'random_context_minus' in self.annotation.columns:
                used_columns.append('random_context_minus')
                renamed_columns.append('random_context_minus')
